...
const TareaState = (props) => {
  const initialState = {
    tareas: [
      ...
      { id: 14, nombre: "Elegir Colores", estado: false, proyectoId: 4 },
      {
        id: 15,
        nombre: "Elegir Plataformas de pago",
        estado: true,
      ...
      { id: 16, nombre: "Elegir Hosting", estado: false, proyectoId: 4 },
    ],
    tareasproyecto: null,
    errortarea: false,
  ...
  //Valida y muestra un error en caso de que sea necesariio
  const validarTarea = () => {
    dispatch({
      type: VALIDAR_TAREA,
    });
